  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 p-5">
      <div className="mb-3 flex items-center justify-between">
        <div>
          <h3 className="font-serif text-xl text-gray-900">Top Products</h3>
          ...
          {top.map((p, i) => (
            <div key={p.perfumeId} className="flex items-center gap-3 rounded-md border border-gray-200 bg-dark/40 p-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-sm font-medium text-gray-900" dir="auto">{p.name}</div>
              ...
              <div className="flex-shrink-0 text-right">
                <div className="text-sm font-semibold text-gray-900">AED {p.revenue.toFixed(0)}</div>
