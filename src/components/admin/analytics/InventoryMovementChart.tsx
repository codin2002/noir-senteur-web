    ...
    <div className="rounded-lg border border-gold/20 bg-darker p-5">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
              ...
              <button
                ...
                className={`rounded px-2.5 py-1 text-[11px] font-medium capitalize transition ${
                  (stacked && m === 'stacked') || (!stacked && m === 'grouped')
                    ? 'bg-gold text-dark' : 'text-gold/70 hover:text-gold'
                }`}
              >
                {m}
              </button>
          ...
          {wideRange && (
            <div className="group relative flex gap-1 rounded-md border border-gold/20 p-1">
              ...
              <span className="pointer-events-none absolute right-0 top-full z-10 mt-1 hidden w-56 rounded-md border border-gold/20 bg-dark p-2 text-[10px] text-gold/80 shadow-lg group-hover:block">
